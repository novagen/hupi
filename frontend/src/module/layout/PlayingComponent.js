...
import { ModuleComponent, ModelTxt, Container } from 'component';

import 'scss/PlayingComponent.scss';
...
class PlayingComponent extends ModuleComponent {
	...
	_renderPlaying() {
		...
		let component = new Elem(n => n.elem('div', {  className: 'playing' }, [
            n.elem('div', { className: 'image' }, [
                n.component(new ModelTxt(this.model, (m, e) => {
                    try {
            ...
            n.elem('div', { className: 'info' }, [
                n.component(new ModelTxt(this.model, (m) => m.artist, { tagName: 'span', className: 'artist' })),
                n.component(new ModelTxt(this.model, (m) => m.track, { tagName: 'span', className: 'track' })),
                n.component(new ModelTxt(this.model, (m) => m.album, { tagName: 'span', className: 'album' }))
            ]),
	...
	render(el) {
		this.node = new Elem(n => n.elem("div", {
			...
			n.component('playing', new Container({ className: 'cell' }))
		]));
